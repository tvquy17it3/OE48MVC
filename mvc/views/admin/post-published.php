                                    ...
                                    <tbody>
                                        ...
                                        foreach ($data['posts'] as $value) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo BASE_URL."admin/post_publish/".$value->id.'/0';?>" onclick="return confirm_post()"><button type="button" class="btn btn-info btn-sm"><span class="badge badge-info">Ẩn bài viết</span></button></a> 
